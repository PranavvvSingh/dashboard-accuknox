...
import { FaRegBell as NotificationIcon } from "react-icons/fa"
   ...
   return (
      <div className="h-[50px] bg-white sticky top-0 left-0 w-full flex justify-between items-center px-5 border-b">
         ...
         <div className="flex items-center px-2 gap-5">
            <NotificationIcon className="text-xl text-neutral-600" />
            <UserIcon className="text-[26px] text-neutral-600" />
         </div>
      </div>
   )
}
